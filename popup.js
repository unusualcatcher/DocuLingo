        ...
        document.getElementById('translateButton').addEventListener('click', function () {
            ...
            if (supportedLanguages[languageInput]) {
                ...
                if (translateWholePage) {
                    ...
                    // Fetch request to translate selected text
                    ...
                    .then(data => {
                        ...
                        document.getElementById('to').innerHTML = `${data.translated_text}` + ` <a href='http://localhost:8000' target='_blank' style='color: #007BFF; text-decoration: underline; font-weight: bold; transition: color 0.3s;'>Elaborate</a>`; 
                    })
                    .catch(error => {
                        console.error('There was a problem with the fetch operation:', error);
                        errorMessage.innerText = 'Error translating text. Please try again.';
